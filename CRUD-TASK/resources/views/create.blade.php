...
<html lang="en">
  ...
  <body>
      <br> <br>
    <center>  <h3> Add a new Course</h3> </center>
    <hr>
    <br>


    <form method="POST" action="{{route('store.course')}}" style="width:60%; margin-left:290px">
        @csrf
...
@enderror
      ...
      @enderror
      <br>
        <a> <button type="submit" class="btn btn-primary">+ Add Course </button> </a>
      </form>
